...
void loop()
{
  ...
  if (valves & 0x0A)    // If two traps is heating at the same time
  {
    setValve(TRAP_1_HEAT, 0);
  ...
  if (valves | 0x0A)    // If heating process is going (bit 2 or 4 is set)
  {
    ...
    else
    {
      ...
      HeatStartMillis = 0;      // Reset counter
    };
