...
void GetC14 (void)
{
  ...
  /*
    ...
    This construction is needed because delay does not work
  ...
  */
  ...
  k = digitalRead(C14_skait_7);
  C14_1 = C14_1 + ((k << 7) & 0x80);
  k = digitalRead(C14_skait_6);
  C14_1 = C14_1 + ((k << 6) & 0x40);
  k = digitalRead(C14_skait_5);
  C14_1 = C14_1 + ((k << 5) & 0x20);
  k = digitalRead(C14_skait_4);
  C14_1 = C14_1 + ((k << 4) & 0x10);
  k = digitalRead(C14_skait_3);
  C14_1 = C14_1 + ((k << 3) & 0x08);
  k = digitalRead(C14_skait_2);
  C14_1 = C14_1 + ((k << 2) & 0x04);
  k = digitalRead(C14_skait_1);
  C14_1 = C14_1 + ((k << 1) & 0x02);
  k = digitalRead(C14_skait_0);
  C14_1 = C14_1 + ((k << 0) & 0x01);
  ...
  k = digitalRead(C14_skait_7);
  C14_2 = C14_2 + ((k << 7) & 0x80);
  k = digitalRead(C14_skait_6);
  C14_2 = C14_2 + ((k << 6) & 0x40);
  k = digitalRead(C14_skait_5);
  C14_2 = C14_2 + ((k << 5) & 0x20);
  k = digitalRead(C14_skait_4);
  C14_2 = C14_2 + ((k << 4) & 0x10);
  k = digitalRead(C14_skait_3);
  C14_2 = C14_2 + ((k << 3) & 0x08);
  k = digitalRead(C14_skait_2);
  C14_2 = C14_2 + ((k << 2) & 0x04);
  k = digitalRead(C14_skait_1);
  C14_2 = C14_2 + ((k << 1) & 0x02);
  k = digitalRead(C14_skait_0);
  C14_2 = C14_2 + ((k << 0) & 0x01);
  ...
  //C14_2 = C14_2 + digitalRead(C14_skait_0) * 32768 + digitalRead(C14_skait_1) * 16384 + digitalRead(C14_skait_2) * 8192 + digitalRead(C14_skait_3) * 4096 + digitalRead(C14_skait_4) * 2048 + digitalRead(C14_skait_5) * 1024 + digitalRead(C14_skait_6) * 512 + digitalRead(C14_skait_7) * 256;
